...
{
	m_uShaderProgramID = LoadShaders("Shaders//BasicColor.vs", "Shaders//BasicColorE05.fs");
...
void AppClass::ProcessKeyboard(sf::Event a_event)
{
	...
	if (a_event.key.code == sf::Keyboard::Key::I)//Check to see if I is pressed and change the inverted value if it was.
...
void AppClass::Display(void)
{
	...
	//read the inverted uniform and send values.
	GLuint Inverted = glGetUniformLocation(m_uShaderProgramID, "Invert");
	glUniform1i(Inverted, m_bInverted);
